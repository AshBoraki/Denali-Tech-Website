(function () {
  ...
  function buildFooter() {
    ...
    cta.href = projectPlanHref;
    var message = makeElement("a", "dt-site-footer-secondary", "Message on WhatsApp");
    message.href = whatsappMessageHref;
